...
author: "Katherine Collao, Joaquin Riquelme, Maureen Murúa, Rodrigo Ramos"
format: html
editor: visual
---
...
fuentes[fuentes=="Santos_2010"] <- "M_076"
fuentes <- substr(x = fuentes, start = regexpr(pattern = "_", text = fuentes)+1,  stop = nchar(fuentes))
fuentes[fuentes=="Kahe"] <- "074"
fuentes[fuentes=="kbcontrol2009"] <- "075.1"
fuentes[fuentes=="kbrest2009"] <- "075.2"
fuentes[fuentes=="Var2012"] <- "077"
fuentes[fuentes=="11.1"] <- "011.1"
fuentes[fuentes=="11.2"] <- "011.2"
fuentes<-fuentes[fuentes!="078"]
fuentes[fuentes=="chaco0611"] <- "079"
fuentes[fuentes=="res_1521"] <- "080"
