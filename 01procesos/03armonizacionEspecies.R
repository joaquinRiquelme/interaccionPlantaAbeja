...
write.csv(ml.arm, file = file.path(dir.salidas,"ml.arm.plantas.abejas.csv"), row.names = FALSE)
...
write.csv(DIT.baseDatos, file.path(dir.salidas, "DIT.baseDatos.csv"), row.names = FALSE)
