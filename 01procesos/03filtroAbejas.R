...
matriz_comp_larga <- read.csv("../01procesos/ml.armonizado.plantas.abejas.csv")
...
write.csv(esp3, "../01procesos/especies3.csv", row.names = FALSE)
...
write.csv(ml.esp.abe, "ml.abejas.csv")
